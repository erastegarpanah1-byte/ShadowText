...
class StegoEncoder(
    ...
    private val carrierTextProvider: CarrierTextProvider
) {
    ...
    fun encode(
        ...
        val carrierText = carrierTextProvider.provide()
        ...
        return EncodeResult(
            ...
            invisibleCharCount = encoder.extractInvisible(invisiblePayload).length,
    ...
    private fun embedPayload(carrierText: String, invisiblePayload: String): String {
        ...
        val insertionPoint = findInsertionPoint(carrierText)
        val prefix = carrierText.substring(0, insertionPoint)
        val suffix = carrierText.substring(insertionPoint)
        return prefix + invisiblePayload + suffix
    }
